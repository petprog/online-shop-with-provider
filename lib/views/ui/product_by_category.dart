            ...
            Padding(
              ...
              child: ClipRRect(
                ...
                child: TabBarView(
                  controller: _tabController,
                  children: [
                    LatestShoes(list: productsNotifier.menSneakersList),
                    LatestShoes(list: productsNotifier.womenSneakersList),
                    LatestShoes(list: productsNotifier.kidsSneakersList),
                  ],
                ),
              ),
            ),
